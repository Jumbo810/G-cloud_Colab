...
read -p "Paste authtoken here (Copy and Ctrl+V to paste then press Enter): " 1hgEcHTKb5tNEdkDXEiXXlcanat_5NpdQ2qDPgXjJgWEqXtvm
./ngrok authtoken 1hgEcHTKb5tNEdkDXEiXXlcanat_5NpdQ2qDPgXjJgWEqXtvm
...
$endc$enda""";
sudo qemu-system-x86_64 -vnc :0 -hda win7.img  -smp cores=3  -m 3000M -machine usb=on -device usb-tablet > /dev/null 2>&1
sleep 43200
